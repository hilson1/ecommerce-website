              ...
              <div class="container py-5">
                <div class="col-sm-12">
                  <div class="headline text-center mb -5">
                    <h2 class="pb-3 position-relative d-inline-block">MOBILES</h2>
                  </div>
                </div>
                  <div class="row g-4">
                      <div class="col-lg-12">
                          ...
                          <div class="row g-4">
                                              ...
                                              <ul class="list-unstyled electro-categorie">
                                                  <li>
                                                      <div class="d-flex justify-content-between electro-name">
                                                          <a href="mobile.php" class="active" style="color: tomato;">
                              ...
                              <div class="row g-4 justify-content-center" id="electro-container">
                                  ...
                                  $products_sql = "SELECT * FROM products where category_id=1";
