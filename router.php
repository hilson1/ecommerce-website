              ...
              <div class="container py-5">
                <div class="col-sm-12">
                  <div class="headline text-center mb -5">
                    <h2 class="pb-3 position-relative d-inline-block">ROUTERS</h2>
                  </div>
                </div>
                  <div class="row g-4">
                      <div class="col-lg-12">
                          ...
                          <div class="row g-4">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <ul class="list-unstyled electro-categorie">
                                                  ...
                                                  <li>
                                                      <div class="d-flex justify-content-between electro-name">
                                                          <a href="speaker.php">
                                                            <i class="fab fa-speaker-deck -alt me-2"></i>Speakers</a>
                                                      </div>
                                                  </li>
                                                  <li>
                                                      <div class="d-flex justify-content-between electro-name">
                                                          <a href="headphone.php" >
                                                            <i class="fas fa-headphones -alt me-2"></i>Headphone</a>
                                                      </div>
                                                  </li>
                                                  <li>
                                                      <div class="d-flex justify-content-between electro-name">
                                                          <a href="router.php" class="active" style="color: tomato;"><i class="fas fa-network-wired -alt me-2"></i>Router</a>
                                                      </div>
                                                  </li>
                                                  <li>
                                                      <div class="d-flex justify-content-between electro-name">
                              ...
                              <div class="row g-4 justify-content-center" id="electro-container">
                                  ...
                                  $products_sql = "SELECT * FROM products where category_id=4";
